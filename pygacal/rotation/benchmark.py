...
def benchmarkMinimizeErrorParameters(translation_errors, rotation_errors, N_list):
...
def benchmarkParameterErrorPlot(N_list, sigma, mapping = BivectorLineMapping, show = True):
    timestring =time.strftime("%Y%m%d-%H%M%S")
